"""
Sistema de Inventario de Electrodomésticos.

Este programa permite registrar y administrar electrodomésticos
(Lavadoras, Refrigeradores y Microondas) mediante Programación
Orientada a Objetos.
...
class Gama(ABC):
    """
    Interfaz abstracta para clasificar electrodomésticos por gama.

    Esta interfaz obliga a las clases derivadas a implementar
    el método tipo_gama(), el cual determina si un producto
    pertenece a la gama Baja, Media o Alta.
    """
    @abstractmethod
    def tipo_gama(self):
        pass
...
class Electrodomestico:
    ...
    def __init__(self, id, marca, modelo, precio):
        ...
        Raises:
            IDvacio: Si el identificador está vacío.
            PrecioInvalido: Si el precio es menor o igual a cero.
        """
    ...
    def __str__(self):
        """
        Devuelve una representación en cadena del electrodoméstico.

        Regresa:
            str: Información general del electrodoméstico.
        """
...
class Lavadora(Electrodomestico, Gama):
    """
    Representa una lavadora dentro del inventario.

    Hereda de Electrodomestico e implementa la interfaz Gama.

    Atributos:
        capacidad (int): Capacidad de carga en kilogramos.
        consumo_agua (int): Consumo de agua en litros.
        ciclos_de_lavado (int): Número de ciclos de lavado.
    """

    def __init__(self, id, marca, modelo, precio, capacidad_carga, consumo_agua, ciclos_de_lavado):
        """
        Inicializa una lavadora.

        Parámetros:
            id (str): Identificador de la lavadora.
            marca (str): Marca de la lavadora.
            modelo (str): Modelo de la lavadora.
            precio (float): Precio de la lavadora.
            capacidad_carga (int): Capacidad de carga en kg.
            consumo_agua (int): Consumo de agua en litros.
            ciclos_de_lavado (int): Número de ciclos de lavado.
        """
    ...
    def __str__(self):
        """
        Devuelve una representación en cadena de la lavadora.

        Regresa:
            str: Información completa de la lavadora.
        """
    ...
    def tipo_gama(self):
        """
        Determina la gama de la lavadora.

        Regresa:
            str: Gama Baja, Gama Media o Gama Alta.
        """
